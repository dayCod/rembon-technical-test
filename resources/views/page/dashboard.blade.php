@extends('layout.backside.app', ['breadcrumb_heading' => 'Beranda', 'breadcrumb_sections' => ['Beranda']])

@section('page-title', 'AZ Product - Beranda')
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Product
                            </h6>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Member
                            </h6>
                        </div>
                        <div class="ms-auto mt-md-3 mt-lg-0">
                            <span class="opacity-7 text-muted">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">Total Leads
                            </h6>
                        </div>
                        <div class="ms-auto mt-md-3 mt-lg-0">
                            <span class="opacity-7 text-muted">
                                <i class="fas fa-assistive-listening-systems" style="font-size: 1.5em"></i>
                            </span>
                        </div>
                    </div>
                </div>
